...
```{r q6fig1, fig.cap= "The trend of total digital infrastructure investment from 1947 to 2017"}
q6 <- investment %>%
...
```{r q6fig2, fig.cap= "The trend of Gross Domestic Product (GDP) from 1947 to 2017"}
ggplot(q6,
       aes(x = year,
           y = GDP_current)) +
  geom_point() +
...
```{r q6fig3, fig.cap= "The relationship between total digital investment and gdp"}
 ggplot(q6,
       aes(x = digital,
           y = GDP_current)) +
  geom_point(shape = 1,
...
```{r q14fig4,fig.cap="The trend of transpotation investment and Gross Domestic Product (GDP) from 1947 to 2017"}
...
```{r q14fig5,fig.cap="The relationship between transportation investment and gdp"}
 ggplot(q14,
...
```{r q18fig6,fig.cap="The trends of private, federal investment and current GDP"}
...
```{r q18fig7, fig.cap="The relationship between investment and GDP"}
...
```{r q20fig8, fig.cap = "The relationship between GDP and total basic infrastructure investment"}
q20 <- investment %>%
