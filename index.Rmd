...
ggplot(q6,
  ...
  theme_bw() +
  ggtitle("Figure 1: The trend of total digital infrastructure investment from 1947 to 2017")
...
ggplot(q6,
  ...
  geom_vline(xintercept = 1990, linetype="dashed", color = "red")+
  theme_bw() +
  ggtitle("Figure 2: The trend of Gross Domestic Product (GDP) from 1947 to 2017")
 ...
 ggplot(q6,
  ...
  geom_smooth(method = "lm",
              col = "red",
              size = 1)+
  ggtitle("Figure 3: The relationship between total digital investment and gdp") +
   theme_bw()
...
transport <- ggplot(q14,
  ...
  geom_point() +
  theme_bw() +
  ggtitle("Figure 4: The trend of transpotation investment from 1947 to 2017")
 # geom_vline(xintercept = 1990, linetype="dashed", color = "red")+
...
gdp <- ggplot(q14,
  ...
  geom_vline(xintercept = 1990, linetype="dashed", color = "red")+
  theme_bw() +
  ggtitle("Figure 5: The trend of Gross Domestic Product (GDP) from 1947 to 2017")
...
grid.arrange(transport, gdp, nrow=2)
 ...
 ggplot(q14,
  ...
  geom_smooth(method = "lm",
              col = "red",
              size = 1)+
  ggtitle("Figure 6: The relationship between transportation investment and gdp") +
   theme_bw()
...
gg1 <- ggplot(q18_P,aes(year,GDP_current)) +
  ...
  theme_bw() +
  ggtitle("Figure 7: Trend of current GDP") 

gg2 <- ggplot(q18_P,aes(year,gross_inv)) +
  geom_line(color="blue") +
  theme_bw()+
  ggtitle("Figure 8: Trend of gross private investment") 

gg3 <-  ggplot(q18_F,aes(year,gross_inv)) +
  geom_line(color="blue") +
  theme_bw() +
  ggtitle("Figure 9: Trend of gross federal investment") 
...
Figure 7 and Figure 8 illustrate the current GDP has a generally increasing trend over time, and the trend of gross private investment is similar to that. While the gross federal investment has fluctuated since around 1980 Figure 9.
...
g3 <- ggplotRegression(lm(GDP_current ~ gross_inv,data = q20)) +
  ...
  theme_bw() +
  ggtitle("Figure 10: Relationship between GDP and total basic infrastructure investment")
g3
```
